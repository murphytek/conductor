...
function getBaseThemeOptions(mode) {
  ...
  return {
    palette: {
      ...
      secondary: {
        main: isDark ? colors.gray02 : colors.white,
        light: colors.bgBrandLight,
        dark: colors.bgBrandDark,
        contrastText: isDark ? colors.white : colors.black,
      },
      text: {
        primary: isDark ? colors.gray13 : colors.black,
        secondary: isDark ? colors.gray10 : colors.blackXLight,
        disabled: isDark ? colors.gray07 : colors.blackXXLight,
        hint: isDark ? colors.gray07 : colors.blackXXLight,
      },
      grey: {
        50: isDark ? colors.gray02 : colors.gray14,
        100: isDark ? colors.gray03 : colors.gray13,
        200: isDark ? colors.gray04 : colors.gray12,
        300: isDark ? colors.gray05 : colors.gray11,
        400: isDark ? colors.gray06 : colors.gray10,
        500: isDark ? colors.gray07 : colors.gray09,
        600: isDark ? colors.gray09 : colors.gray07,
        700: isDark ? colors.gray10 : colors.gray06,
        800: isDark ? colors.gray12 : colors.gray04,
        900: isDark ? colors.gray14 : colors.gray02,
        A100: isDark ? colors.gray04 : colors.gray12,
        A200: isDark ? colors.gray08 : colors.gray08,
        A400: isDark ? colors.gray13 : colors.gray03,
        A700: isDark ? colors.gray10 : colors.gray06,
      },
      error: {
        main: isDark ? colors.red08 : colors.failure,
        light: isDark ? colors.red10 : colors.failureLight,
        dark: isDark ? colors.red06 : colors.failureDark,
        contrastText: colors.white,
      },
      background: {
        paper: isDark ? colors.gray02 : colors.white,
        default: isDark ? colors.gray01 : colors.gray14,
      },
      divider: isDark ? "rgba(255,255,255,0.12)" : colors.blackXXLight,
    },
    typography: {
...
function getOverrides(baseTheme, mode) {
  const isDark = mode === "dark";
  ...
  return {
    overrides: {
      ...
      MuiButton: {
        ...
        outlinedPrimary: {
          border: isDark ? `1px solid ${colors.gray07}` : borders.blackRegular1px,
        },
        outlinedSecondary: {
          border: isDark ? `1px solid ${colors.gray06}` : borders.blackLight1px,
          color: baseTheme.palette.secondary.contrastText,
          "&:hover": {
            border: (isDark ? `1px solid ${colors.gray06}` : borders.blackLight1px) + " !important",
            backgroundColor: baseTheme.palette.grey.A100,
          },
        },
        contained: {
      ...
      MuiCheckbox: {
        ...
        colorSecondary: {
          color: isDark ? colors.gray08 : colors.blackLight,
          "&$checked": {
            color: baseTheme.palette.primary.main,
          },
          "&$disabled": {
            color: isDark ? colors.gray05 : colors.blackXLight,
          },
        },
      },
      MuiChip: {
      ...
      MuiOutlinedInput: {
        notchedOutline: {
          borderColor: isDark ? colors.gray05 : colors.blackXXLight,
          top: 0,
          "& legend": {
        ...
        root: {
          "&:hover $notchedOutline": {
            borderColor: isDark ? colors.gray07 : colors.blackXXLight,
          },
          "&.$Mui-disabled": {
            backgroundColor: isDark ? colors.gray03 : colors.grayXXLight,
            borderColor: isDark ? colors.gray05 : colors.blackXXLight,
            color: isDark ? colors.gray08 : colors.blackLight,
          },
      ...
      MuiInputLabel: {
        root: {
          ...
          "&.$Mui-disabled": {
            color: isDark ? colors.gray06 : colors.blackXLight,
          },
        },
        outlined: {
          "&$shrink": {
      ...
      MuiSwitch: {
        ...
        track: {
          backgroundColor: isDark ? colors.gray05 : colors.gray07,
          borderRadius: 10,
          opacity: 1,
        },
        switchBase: {
      ...
      MuiTableCell: {
        root: {
          fontSize: fontSizes.fontSize2,
          borderBottomColor: isDark ? colors.gray04 : undefined,
        },
        head: {
          //border: 'none',
          fontWeight: fontWeights.fontWeight1,
          color: isDark ? colors.gray09 : colors.gray05,
        },
      },
      MuiTableRow: {
        root: {
          "&.Mui-selected:hover": {
            backgroundColor: isDark ? colors.gray03 : colors.gray12,
          },
          "&.Mui-selected": {
            backgroundColor: isDark
              ? `${colors.gray03} !important`
              : `${colors.gray12} !important`,
          },
        },
      },
      MuiDialogTitle: {
        root: {
          backgroundColor: isDark ? colors.gray03 : baseTheme.palette.grey[50],
          padding: `${baseTheme.spacing("space5")}px ${baseTheme.spacing(
            "space4"
          )}px`,
          borderBottom: `1px solid ${isDark ? colors.gray04 : colors.blackXXLight}`,
        },
      },
      MuiDialogContent: {
        root: {
      ...
      MuiDialogActions: {
        root: {
          ...
          borderTop: `1px solid ${isDark ? colors.gray04 : colors.blackXXLight}`,
          margin: 0,
      ...
      MuiAppBar: {
        colorPrimary: {
          backgroundColor: isDark ? colors.gray02 : colors.white,
          color: isDark ? colors.gray13 : colors.gray00,
        },
        root: {
          zIndex: 999,
          paddingLeft: 20,
          paddingRight: 20,
          boxShadow: isDark
            ? "0 4px 8px 0 rgb(0 0 0 / 30%), 0 0 2px 0 rgb(0 0 0 / 30%)"
            : "0 4px 8px 0 rgb(0 0 0 / 10%), 0 0 2px 0 rgb(0 0 0 / 10%)",
          height: 80,
          "& .MuiButton-label": {
            color: isDark ? colors.gray13 : colors.black,
          },
...
export function createTheme(mode = "light") {
  const baseThemeOptions = getBaseThemeOptions(mode);
  const baseTheme = createMuiTheme(baseThemeOptions);
  const overrides = getOverrides(baseTheme, mode);
